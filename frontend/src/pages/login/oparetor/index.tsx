  ...
  const onFinish = async (values: OparetorsInterface) => {
    try {
      ...
      if (res.status) {
        ...
        // setTimeout(() => {
        //   navigate("/register/oparetornext");
        // }, 2000);
      } else {
            ...
            <Card style={{ height: "130px",marginBottom: "-30px",}}>
              <div className="label" style={{ marginLeft: "30px", marginRight: "30px" }}>
                <p className="div">
                  ...
                  <Button className="custom-button" danger>เข้าสู่ระบบสำหรับผู้หางาน</Button>
                  {/* <span className="space2"></span> */}
                </p>
                {/* <p className="image">
                  <br />
            ...
            <Card style={{ height: "85px",marginTop: "-15px",}}>
              <div className="label" style={{ marginLeft: "18px", marginRight: "30px" }}>
                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                  ...
                  <span>&nbsp;&nbsp;</span>
                  <Link to='/register/oparetor' className='custom-button3' type="link">
                    ลงทะเบียน
                  </Link>
                  <span>&nbsp;&nbsp;</span>
