            ...
            <Card style={{ height: "200px",marginBottom: "0px",}}>
              <div className="label" style={{ marginLeft: "100px", marginRight: "10px" }}>
                ...
                <Row gutter={[16, 0]}>
                  ...
                  <Link to='/register/user' className='custom-button3' type="link" style={{ fontSize: '18px' ,marginLeft: '5px',color: 'green' }} >
                    โพสต์ประกาศงาน
                  </Link>
                  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
                  <Link to='/register/user' className='custom-button3' type="link" style={{ fontSize: '18px' ,marginLeft: 'px',color: 'red' }}>
                    รายชื่อผู้สมัคร
                  </Link>
                  <span>&nbsp;&nbsp;&nbsp;</span> 
                  <Link to='/register/user' className='custom-button3' type="link" style={{ fontSize: '18px' ,marginLeft: '5px',color: 'orange' }}>
                    ดูประกาศงานฉบับร่าง
                  </Link>
                  {/* <span className="space2"></span> */}
                </p>
